...
import (
	...
	"github.com/karmada-io/karmada/examples/volcanointerpreter/webhook/app/options"
...
func Run(ctx context.Context, opts *options.Options) error {
	...
	hookServer.Register("/interpreter-workload", interpreter.NewWebhook(&volcanoInterpreter{}, interpreter.NewDecoder(gclient.NewSchema())))
